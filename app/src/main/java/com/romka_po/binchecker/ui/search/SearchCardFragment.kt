...
class SearchCardFragment : Fragment(), CoroutineScope by MainScope() {
    ...
    override fun onCreateView(
        ...
        viewModel =
            ViewModelProvider(this, viewModelProviderFactory).get(SearchCardModel::class.java)
    ...
    fun checkAll(data: Card) {
        ...
        latLabel.text =
            (data.country?.latitude.toString() + "," + data.country?.longitude.toString())
        catchMap(latLabel)
    }
